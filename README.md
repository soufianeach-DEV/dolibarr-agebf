...
├── core/
│   └── modules/
│       └── modAgeBF.class.php        # Descripteur v5.2 (cron, extrafields, menus)
├── class/
...
1. Télécharger **`module_agebf-5.2.zip`** depuis la [page Releases](https://github.com/soufianeach-DEV/dolibarr-agebf/releases)
